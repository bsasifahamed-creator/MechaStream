...
Used when calling Ollama/AI to convert user prompts → valid JSON app schema only.
No code, no markdown, no explanations.
"""

SCHEMA_GENERATOR_SYSTEM_PROMPT = """You are a structured app schema generator for MechaStream,
